...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    welcome_text = visual.TextStim(win=win, name='welcome_text',
        text='Welcome to the MRI lab of the University Regensburg!\n\nWe are setting up the scanner and we will start soon...\n\nThank you for participating!',
        font='Arial',
    ...
    hand_intro_text = visual.TextStim(win=win, name='hand_intro_text',
        text="During the tasks, you will have to push the buttons with your fingers on your right hand. \n\nWe will refer to each finger during the task with numbers.\n\nLet's practice using the buttons!\nIf you are ready to practice, push any button.",
        font='Arial',
