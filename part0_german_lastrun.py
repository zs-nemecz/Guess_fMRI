...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\Users\\Asus\\Documents\\pretest_fmri\\Guess_fMRI\\part0_german_lastrun.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    hand_intro_text = visual.TextStim(win=win, name='hand_intro_text',
        text='Während der Aufgaben wirst du die Tasten mit den Fingern deiner rechten Hand drücken.\n\nJeder Finger wird während der Aufgabe mit einer Zahl zugeordnet.\n\nLass uns das Drücken der Tasten üben!\nWenn du bereit dazu bist zu üben, drücke eine beliebige Taste. \n\n',
        font='Arial',
    ...
    select_video_text = visual.TextStim(win=win, name='select_video_text',
        text='Super!\n\nJetzt machen wir die strukturelle Aufnahme.\nDu kannst währenddessen per Tastendruck ein Video auswählen, das du dir anschauen möchtest:\n1) Tierbabys\n2) Tiefsee\n3) Schottland\n4) Brasilien',
        font='Arial',
        pos=(0, 0), draggable=False, height=0.05, wrapWidth=None, ori=0.0, 
        color='white', colorSpace='rgb', opacity=None, 
        languageStyle='LTR',
    ...
    video_text = visual.TextStim(win=win, name='video_text',
        text='Das Video wird geladen...\n\nWir starten jetzt den Scanner. Bitte bleib still liegen.',
        font='Arial',
        pos=(0, 0), draggable=False, height=0.05, wrapWidth=None, ori=0.0, 
        color='white', colorSpace='rgb', opacity=None, 
        languageStyle='LTR',
